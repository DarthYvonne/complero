    ...
    <div class="container-fluid">
        ...
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.mailing-lists.create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="{{ route('admin.mailing-lists.show', $list) }}" class="btn btn-outline-primary">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>
                                                <a href="{{ route('admin.mailing-lists.edit', $list) }}" class="btn btn-outline-primary">
                                                    <i class="fa-solid fa-pen"></i>
                                                </a>
                                                <form action="{{ route('admin.mailing-lists.destroy', $list) }}" method="POST" class="d-inline"
