        ...
        <div class="row g-3">
            @forelse($courses as $course)
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card clickable-card" data-href="{{ route('admin.courses.show', $course) }}" style="cursor: pointer;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-text" style="font-size: 14px; font-weight: 300; color: #666; margin-bottom: 15px;">
                                ...
                                @if(strlen(strip_tags($course->description)) > 200)
                                    <a href="{{ route('admin.courses.show', $course) }}" style="color: {{ $courseColor }}; text-decoration: underline;">læs resten</a>
                                @endif
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
