...
@section('breadcrumbs')
    ...
    <a href="{{ route('admin.resources.index') }}" style="color: #999; text-decoration: none; transition: color 0.2s;">Downloads</a>
    <span style="margin: 0 8px;">/</span>
    <a href="{{ route('admin.resources.show', $resource) }}" style="color: #999; text-decoration: none; transition: color 0.2s;">{{ $resource->title }}</a>
    <span style="margin: 0 8px;">/</span>
                                    ...
                                    <div class="list-group">
                                        @foreach($resource->files as $file)
                                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                                ...
                                                <form action="{{ route('admin.resources.files.destroy', [$resource, $file]) }}" method="POST" class="d-inline"
        ...
        <div class="card border-0 shadow-sm mt-4">
            ...
            <div class="card-body">
                        ...
                        <div class="list-group">
                            @foreach($resource->tabs as $tab)
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('admin.resources.tabs.destroy', [$resource, $tab]) }}" method="POST" class="d-inline"
                ...
                <div>
                    ...
                    <form action="{{ route('admin.resources.tabs.store', $resource) }}" method="POST">
                        @csrf
