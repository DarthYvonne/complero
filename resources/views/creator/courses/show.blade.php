                                ...
                                @foreach($course->lessons->sortBy('order') as $lesson)
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <a href="{{ route('creator.courses.lessons.edit', [$course, $lesson]) }}" class="btn btn-outline-primary" title="Rediger">
                                                <i class="fa-solid fa-pen"></i>
                                            </a>
                                            <form action="{{ route('creator.courses.lessons.destroy', [$course, $lesson]) }}" method="POST" class="d-inline"
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <form action="{{ route('creator.courses.destroy', $course) }}" method="POST"
